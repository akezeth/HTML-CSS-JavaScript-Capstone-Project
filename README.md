...
You can find a live demo in [HERE](https://akezeth.github.io/HTML-CSS-JavaScript-Capstone-Project/).
...
```sh
  ...
  git clone git@github.com:akezeth/HTML-CSS-JavaScript-Capstone-Project.git
```
